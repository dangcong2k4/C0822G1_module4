...
public class CustomerController {
    ...
    @PostMapping("/create")
    public String createProduct(@Validated @ModelAttribute("customerDto") CustomerDto customerDto, BindingResult bindingResult, Model model,RedirectAttributes redirectAttributes){
